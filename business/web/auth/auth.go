...
func (a *Auth) Authenticate(ctx context.Context, bearerToken string) (Claims, error) {
	...
	//a.Log.Info("opaAuthentication", input)
...
func (a *Auth) opaPolicyEvaluation(ctx context.Context, opaPolicy string, rule string, input any) error {
	...
	// Add logging for the input being passed to the policy
	a.Log.Infof("OPA Policy Input: %+v", input)
	...
	// Add logging for the results returned by the policy
	a.Log.Infof("OPA Policy Results: %+v", results)
